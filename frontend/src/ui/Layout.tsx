...
const Layout: React.FC<LayoutProps> = ({ children }) => {
    const { isAudioActive, initializeAudio, stopAudio } = useAudioEngine();
            ...
            <div className="h-12 border-b border-[var(--color-border)] flex items-center px-6 bg-[var(--color-bg)] select-none">
                ...
                <div className="flex gap-2">
                    <TerminalButton
                        ...
                        className={`transition-all duration-300 min-w-[124px] ${isAudioActive
                    ...
                    >
                        <div className="flex items-center justify-center gap-2">
                            ...
                            {isAudioActive ? 'SYSTEM: ON' : 'POWER: OFF'}
                        </div>
                    </TerminalButton>
                    <TerminalButton onClick={() => console.log('Settings clicked')} className="hover:border-[var(--color-accent-primary)]/50 group">
